...
from web.models.Character import Character, CharacterVoice
...
@receiver(pre_delete, sender=CharacterVoice)
def cleanup_character_voice(sender, instance, **kwargs):
    delete_old_audio(instance.preview_voice)
